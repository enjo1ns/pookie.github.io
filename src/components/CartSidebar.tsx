      ...
      <div className="fixed inset-0 z-50 flex">
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-white border-opacity-10">
            <h2 
              className="font-cinzel text-xl text-white"
              style={{
          ...
          {items.length > 0 && (
            <div className="p-6 border-t border-white border-opacity-10">
              ...
              <Button
                ...
                className="w-full bg-white text-black hover:bg-gray-200 font-medium py-3 transition-all duration-300 hover:scale-105"
                style={{
